...
- [Low-level escape hatch](../guide/low-level-escape-hatch.qmd) — where v1 `app.api` calls migrate to
- [API Reference](../reference/index.qmd) — rendered v2 surface
- [ADR-001: Two-layer API](../design/adr/adr-001-v2-redesign.qmd) — why v2 split this way
