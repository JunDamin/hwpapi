...
subtitle: "Insert page headers, footers, and page numbers programmatically"
---
...
`HeaderFooter` 클래스 또는 [Reference 페이지](../reference/parametersets/HeaderFooter.qmd)
에서 확인하세요.
...
- [Reference: actions](../reference/low/actions.qmd)
