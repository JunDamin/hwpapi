...
- [Low-level escape hatch (영문)](../guide/low-level-escape-hatch.html) — v1 `app.api` 호출이 어디로 이동하는지
- [API Reference (영문)](../reference/index.html) — 렌더된 v2 surface
- [ADR-001: Two-layer API (영문)](../design/adr/adr-001-v2-redesign.html) — v2 가 이렇게 분할된 이유
