...
([`Document`](../../reference/Document.html) 인스턴스):
...
[`hwpapi.low`](../../guide/low-level-escape-hatch.html) 로 내려가세요:
...
- 실전 예제가 더 필요하면 → [Recipes (영문)](../recipes/index.html)
- 특정 클래스를 찾고 싶다면 → [Reference (영문)](../reference/index.html)
