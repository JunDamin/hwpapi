        ...
        **선택 영역 배경색 노랑** — 승승아빠 매크로 Alt+Shift+2 이식.
        ...
        try:
            ...
            if toggle and cur and str(cur).lower() in ("#ffff00", "ffff00", "16776960"):
                ...
                # Note: shade_color persists on cursor after selection-apply.
                # Use `app.styled_text("text", shade_color="#FFFF00")` for
                # bleed-safe highlighting (snapshot/restore pattern).
        except Exception as e:
