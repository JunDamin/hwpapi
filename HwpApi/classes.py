...
# %% ../nbs/02_api/03_classes.ipynb #4a4ea9f9
import inspect
...
# %% ../nbs/02_api/03_classes.ipynb #82524eb1
class MoveAccessor:
    """
...
# %% ../nbs/02_api/03_classes.ipynb #01b1d790-e949-4cf8-8dec-d4664d3a901f
class CellAccessor:
    """
...
# %% ../nbs/02_api/03_classes.ipynb #66b558cf
class TableAccessor:
    """
...
# %% ../nbs/02_api/03_classes.ipynb #cd58cfd2
class PageAccessor:
...
# %% ../nbs/02_api/03_classes.ipynb #5c42f8be-abd0-4053-a680-ff835c66f538
@dataclass
class Character:
...
# %% ../nbs/02_api/03_classes.ipynb #c5f5af74-a331-4b51-a48a-ee9ea6301858
import inspect
...
# %% ../nbs/02_api/03_classes.ipynb #03803de3-9258-409a-a253-06ef0376c618
@dataclass
class Paragraph:
...
# %% ../nbs/02_api/03_classes.ipynb #163f1348-b5ea-4a77-9069-2524f9a01608
class ParaShape:
    """
...
# %% ../nbs/02_api/03_classes.ipynb #a7bf1d9c-570f-44af-945f-29fdfd205af5
@dataclass
class PageShape:
    MarginLeft: int
