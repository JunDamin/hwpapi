...
_action_info = {
    "AddHanjaWord": ["AddHanjaWord", "한자단어 등록"],
    ...
    "Copy": ["SelectionOpt", "복사하기"],
    "CopyPage": [None, "페이지 복사하기"],
    "Cut": ["SelectionOpt", "오려두기"],
    "Delete": [None, "Delete"],
    ...
    "DrawObjTemplateSave": ["DrawObjTemplateSave", "그리기 마당에 등록"],
    ...
    "Erase": ["SelectionOpt", "지우기"],
    "ExchangeFootnoteEndnote": ["ExchangeFootnoteEndNote", "각주/미주 변환"],
    "ExecReplace": ["FindReplace", "바꾸기(실행)"],
    "FileClose": [None, "문서 닫기"],
    "FileNew": [None, "새문서"],
    "FileOpen": ["FileOpenSave", "파일 열기"],
    "FileOpenMRU": ["FileOpenSave", "최근 작업 문서"],
    "FilePassword": ["Password", "문서 암호"],
    "FilePreview": ["Print", "미리 보기"],
    "FileQuit": [None, "끝"],
    "FileSave": ["FileOpenSave", "파일 저장"],
    "FileSaveAs": ["FileOpenSave", "다른 이름으로 저장"],
    "FileSetSecurity": [
        "FileSetSecurity",
    ...
    "FtpDownload": ["FtpUpload", "FTP서버에서 파일 다운 받아 문서 오픈하기"],
    ...
    "HeaderFooterToNext": ["HeaderFooter", "이후 머리말"],
    ...
    "Idiom": ["Idiom", "상용구"],
    "ImageFindPath": ["FindImagePath", "그림 경로 찾기"],
    ...
    "InputHanja": ["InputHanja", "한자 변환"],
    "InputHanjaBusu": ["InputHanjaBusu", "부수로 입력"],
    "InputHanjaMean": ["InputHanjaMean", "새김으로 입력"],
    "InsertAutoNum": [None, "번호 다시 넣기"],
    "InsertCCLMark": ["CCLMark", "CCL 넣기"],
    "InsertChart": ["ChartObjShape", "차트 만들기"],
    ...
    "MacroRepeatDlg": ["ScriptMacro", "매크로 실행"],
    ...
    "MPSectionToNext": ["MasterPage", "이후 구역으로"],
    "MPSectionToPrevious": ["MasterPage", "이전 구역으로"],
    ...
    "PictureEffect1": ["ShapeObject", "그림 그레이 스케일"],
    "PictureEffect2": ["ShapeObject", "그림 흑백으로"],
    "PictureEffect3": ["ShapeObject", "그림 워터마크"],
    "PictureEffect4": ["ShapeObject", "그림 효과 없음"],
    "PictureEffect5": ["ShapeObject", "그림 밝기 증가"],
    "PictureEffect6": ["ShapeObject", "그림 밝기 감소"],
    "PictureEffect7": ["ShapeObject", "그림 명암 증가"],
    "PictureEffect8": ["ShapeObject", "그림 명암 감소"],
    "PictureInsertDialog": ["ShapeObject", "그림 넣기 (대화상자를 띄워 선택한 이미지 파일을 문서에 삽입하는 액션 : API용)"],
    "PictureLinkedToEmbedded": ["ShapeObject", "연결된 그림을 모두 삽입그림으로"],
    "PictureSave": ["ShapeObjSaveAsPicture", "그림 빼내기"],
    ...
    "QuickCorrect": ["QCorrect", "빠른 교정 (실질적인 동작 Action)"],
    ...
    "ShapeObjSaveAsPicture": ["ShapeObjSaveAsPicture", "그리기개체를 그림으로 저장하기"],
    "ShapeObjSelect": [None, "틀 선택 도구"],
    "ShapeObjSendBack": [None, "뒤로"],
    "ShapeObjSendToBack": [None, "맨 뒤로"],
    "ShapeObjShadowEnlarge": ["ShapeObject", "그리기 개체 그림자를 큰 형태로 변경그림자가 없으면 생성한다."],
    "ShapeObjShadowMoveDown": ["ShapeObject", "그리기 개체 그림자를 밑으로 이동시킨다. 그림자가 없으면 생성한다."],
    "ShapeObjShadowMoveLeft": ["ShapeObject", "그리기 개체 그림자를 왼쪽으로 이동시킨다. 그림자가 없으면 생성한다."],
    "ShapeObjShadowMoveRight": ["ShapeObject", "그리기 개체 그림자를 오른쪽으로 이동시킨다. 그림자가 없으면 생성한다."],
    "ShapeObjShadowMoveUp": ["ShapeObject", "그리기 개체 그림자를 위로 이동시킨다. 그림자가 없으면 생성한다."],
    "ShapeObjShadowNarrow": ["ShapeObject", "그리기 개체 그림자를 작은 형태로 변경. 그림자가 없으면 생성한다."],
    "ShapeObjShadowParellelLeftBottom": ["ShapeObject", "그리기 개체 그림자를 원본 개체와 동일한 크기로 왼쪽하단에 생성한다."],
    "ShapeObjShadowParellelLeftTop": ["ShapeObject", "그리기 개체 그림자를 원본 개체와 동일한 크기로 왼쪽상단에 생성한다."],
    "ShapeObjShadowParellelRightBottom": ["ShapeObject", "그리기 개체 그림자를 원본 개체와 동일한 크기로 오른쪽하단에 생성한다."],
    "ShapeObjShadowParellelRightTop": ["ShapeObject", "그리기 개체 그림자를 원본 개체와 동일한 크기로 오른쪽상단에 생성한다."],
    "ShapeObjShadowShearLeftBottom": ["ShapeObject", "그리기 개체 그림자를 왼쪽 뒷부분으로 눕혀서 생성한다."],
    "ShapeObjShadowShearLeftTop": ["ShapeObject", "그리기 개체 그림자를 왼쪽 앞부분으로 눕혀서 생성한다."],
    "ShapeObjShadowShearRightBottom": ["ShapeObject", "그리기 개체 그림자를 오른쪽 뒷부분으로 눕혀서 생성한다."],
    "ShapeObjShadowShearRightTop": ["ShapeObject", "그리기 개체 그림자를 오른쪽 앞부분으로 눕혀서 생성한다."],
    ...
    "Sort": ["Sort", "소트"],
    "SpellingCheck": ["SpellingCheck", "맞춤법"],
    ...
    "Sum": ["Sum", "블록 합계"],
    "TableAppendRow": ["TableInsertLine", "줄 추가"],
    ...
    "TableDeleteCell": ["SelectionOpt", "셀 삭제"],
    ...
    "TableDrawPen": ["TableDrawPen", "표 그리기"],
    "TableEraser": ["TableDrawPen", "표 지우개"],
