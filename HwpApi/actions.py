# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/tutorials/01_actions.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/tutorials/01_actions.ipynb 4
# preset action data <Action key>: [<parameter key>, <description>]

_action_info = {'AddHanjaWord': [None, '한자단어 등록'],
...
# %% ../nbs/tutorials/01_actions.ipynb 5
class _Action:
...
# %% ../nbs/tutorials/01_actions.ipynb 7
class _Actions:
