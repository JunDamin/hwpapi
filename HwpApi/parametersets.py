...
# %% auto 0
__all__ = ['ParameterSet', 'FindReplace', 'CharShape', 'BorderFill', 'DrawFillAttr', 'TabDef', 'NumberingShape', 'BulletShape',
           'DrawImageAttr', 'ParaShape']
...
\- CounterSlashFlag(CounterBackSlashFlag)  
    ...
    def border_type_left(self):
        ...
        return self._pset.Item("BorderTypeLeft")

    @border_type_left.setter
    def border_type_left(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderTypeLeft")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderTypeLeft", value)

    @property
    def border_type_right(self):
        """테두리 유형 (오른쪽): 정수 값을 입력하세요."""
        return self._pset.Item("BorderTypeRight")

    @border_type_right.setter
    def border_type_right(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderTypeRight")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderTypeRight", value)

    @property
    def border_type_top(self):
        """테두리 유형 (위): 정수 값을 입력하세요."""
        return self._pset.Item("BorderTypeTop")

    @border_type_top.setter
    def border_type_top(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderTypeTop")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderTypeTop", value)

    @property
    def border_type_bottom(self):
        """테두리 유형 (아래): 정수 값을 입력하세요."""
        return self._pset.Item("BorderTypeBottom")

    @border_type_bottom.setter
    def border_type_bottom(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderTypeBottom")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderTypeBottom", value)

    @property
    def border_width_left(self):
        """테두리 두께 (왼쪽): 정수 값을 입력하세요."""
        return self._pset.Item("BorderWidthLeft")

    @border_width_left.setter
    def border_width_left(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderWidthLeft")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderWidthLeft", value)

    @property
    def border_width_right(self):
        """테두리 두께 (오른쪽): 정수 값을 입력하세요."""
        return self._pset.Item("BorderWidthRight")

    @border_width_right.setter
    def border_width_right(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderWidthRight")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderWidthRight", value)

    @property
    def border_width_top(self):
        """테두리 두께 (위): 정수 값을 입력하세요."""
        return self._pset.Item("BorderWidthTop")

    @border_width_top.setter
    def border_width_top(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderWidthTop")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderWidthTop", value)

    @property
    def border_width_bottom(self):
        """테두리 두께 (아래): 정수 값을 입력하세요."""
        return self._pset.Item("BorderWidthBottom")

    @border_width_bottom.setter
    def border_width_bottom(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderWidthBottom")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderWidthBottom", value)

    @property
    def border_color_left(self):
        """테두리 색상 (왼쪽): 정수 값을 입력하세요."""
        return self._pset.Item("BorderColorLeft")

    @border_color_left.setter
    def border_color_left(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderColorLeft")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderColorLeft", value)

    @property
    def border_color_right(self):
        """테두리 색상 (오른쪽): 정수 값을 입력하세요."""
        return self._pset.Item("BorderColorRight")

    @border_color_right.setter
    def border_color_right(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderColorRight")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderColorRight", value)

    @property
    def border_color_top(self):
        """테두리 색상 (위): 정수 값을 입력하세요."""
        return self._pset.Item("BorderColorTop")

    @border_color_top.setter
    def border_color_top(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderColorTop")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderColorTop", value)

    @property
    def border_color_bottom(self):
        """테두리 색상 (아래): 정수 값을 입력하세요."""
        return self._pset.Item("BorderColorBottom")

    @border_color_bottom.setter
    def border_color_bottom(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderColorBottom")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BorderColorBottom", value)

    @property
    def slash_flag(self):
        """대각선 플래그: 정수 값을 입력하세요."""
        return self._pset.Item("SlashFlag")

    @slash_flag.setter
    def slash_flag(self, value):
        if value is None:
            return self._pset.RemoveItem("SlashFlag")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("SlashFlag", value)

    @property
    def backslash_flag(self):
        """역대각선 플래그: 정수 값을 입력하세요."""
        return self._pset.Item("BackSlashFlag")

    @backslash_flag.setter
    def backslash_flag(self, value):
        if value is None:
            return self._pset.RemoveItem("BackSlashFlag")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("BackSlashFlag", value)

    @property
    def diagonal_type(self):
        """대각선 유형: 정수 값을 입력하세요."""
        return self._pset.Item("DiagonalType")

    @diagonal_type.setter
    def diagonal_type(self, value):
        if value is None:
            return self._pset.RemoveItem("DiagonalType")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("DiagonalType", value)

    @property
    def diagonal_width(self):
        """대각선 두께: 정수 값을 입력하세요."""
        return self._pset.Item("DiagonalWidth")

    @diagonal_width.setter
    def diagonal_width(self, value):
        if value is None:
            return self._pset.RemoveItem("DiagonalWidth")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        self._pset.SetItem("DiagonalWidth", value)

    @property
    def diagonal_color(self):
        """대각선 색상: 정수 값을 입력하세요."""
        return self._pset.Item("DiagonalColor")

    @diagonal_color.setter
    def diagonal_color(self, value):
        if value is None:
            return self._pset.RemoveItem("DiagonalColor")
        
    @property
    def border_fill_3d(self):
        """3차원 효과: 0 = off, 1 = on"""
        return self._pset.Item("BorderFill3D")

    @border_fill_3d.setter
    def border_fill_3d(self, value):
        if value is None:
            return self._pset.RemoveItem("BorderFill3D")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("BorderFill3D", value)

    @property
    def shadow(self):
        """그림자 효과: 0 = off, 1 = on"""
        return self._pset.Item("Shadow")

    @shadow.setter
    def shadow(self, value):
        if value is None:
            return self._pset.RemoveItem("Shadow")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("Shadow", value)

    @property
    def fill_attr(self):
        """배경 채우기 속성"""
        return self._pset.Item("FillAttr")

    @fill_attr.setter
    def fill_attr(self, value):
        if value is None:
            return self._pset.RemoveItem("FillAttr")
        # Assuming `DrawFillAttr` is a class or set object
        assert isinstance(value, DrawFillAttr), "값은 DrawFillAttr 객체이어야 합니다."
        return self._pset.SetItem("FillAttr", value)

    @property
    def crooked_slash_flag(self):
        """꺾인 대각선 플래그 (bit 0, 1)"""
        return self._pset.Item("CrookedSlashFlag")

    @crooked_slash_flag.setter
    def crooked_slash_flag(self, value):
        if value is None:
            return self._pset.RemoveItem("CrookedSlashFlag")
        assert isinstance(value, int), "값은 정수이어야 합니다."
        return self._pset.SetItem("CrookedSlashFlag", value)

    @property
    def break_cell_separate_line(self):
        """자동으로 나뉜 표의 경계선 설정: 0 = 기본 값, 1 = 사용자 설정"""
        return self._pset.Item("BreakCellSeparateLine")

    @break_cell_separate_line.setter
    def break_cell_separate_line(self, value):
        if value is None:
            return self._pset.RemoveItem("BreakCellSeparateLine")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("BreakCellSeparateLine", value)

    @property
    def counter_slash_flag(self):
        """슬래쉬 대각선의 역방향 플래그: 0 = 순방향, 1 = 역방향"""
        return self._pset.Item("CounterSlashFlag")

    @counter_slash_flag.setter
    def counter_slash_flag(self, value):
        if value is None:
            return self._pset.RemoveItem("CounterSlashFlag")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("CounterSlashFlag", value)

    @property
    def counter_back_slash_flag(self):
        """역슬래쉬 대각선의 역방향 플래그: 0 = 순방향, 1 = 역방향"""
        return self._pset.Item("CounterBackSlashFlag")

    @counter_back_slash_flag.setter
    def counter_back_slash_flag(self, value):
        if value is None:
            return self._pset.RemoveItem("CounterBackSlashFlag")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("CounterBackSlashFlag", value)

    @property
    def center_line_flag(self):
        """중심선 플래그: 0 = 없음, 1 = 있음"""
        return self._pset.Item("CenterLineFlag")

    @center_line_flag.setter
    def center_line_flag(self, value):
        if value is None:
            return self._pset.RemoveItem("CenterLineFlag")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("CenterLineFlag", value)

    @property
    def crooked_slash_flag1(self):
        """슬래쉬 대각선의 꺾임 여부 (저바이트)"""
        return self._pset.Item("CrookedSlashFlag1")

    @crooked_slash_flag1.setter
    def crooked_slash_flag1(self, value):
        if value is None:
            return self._pset.RemoveItem("CrookedSlashFlag1")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("CrookedSlashFlag1", value)

    @property
    def crooked_slash_flag2(self):
        """역슬래쉬 대각선의 꺾임 여부 (고바이트)"""
        return self._pset.Item("CrookedSlashFlag2")

    @crooked_slash_flag2.setter
    def crooked_slash_flag2(self, value):
        if value is None:
            return self._pset.RemoveItem("CrookedSlashFlag2")
        assert value in [0, 1], "값은 0 또는 1이어야 합니다."
        return self._pset.SetItem("CrookedSlashFlag2", value)
