...
class ShapeObject(ParameterSet):
    ...
    @property
    def shape_form_general(self):
        """양식개체 일반."""
        value = self._get_value("ShapeFormGeneral")
        if value is not None and not isinstance(value, FormGeneral):
            return FormGeneral(value)
        return value

    @shape_form_general.setter
    def shape_form_general(self, value):
        if value is None:
            return self._del_value("ShapeFormGeneral")
        assert isinstance(value, FormGeneral), "값은 FormGeneral 객체이어야 합니다."
        self._set_value("ShapeFormGeneral", value)

    @property
    def shape_form_common_attr(self):
        """양식개체 공통속성."""
        value = self._get_value("ShapeFormCommonAttr")
        if value is not None and not isinstance(value, FormCommonAttr):
            return FormCommonAttr(value)
        return value

    @shape_form_common_attr.setter
    def shape_form_common_attr(self, value):
        if value is None:
            return self._del_value("ShapeFormCommonAttr")
        assert isinstance(value, FormCommonAttr), "값은 FormCommonAttr 객체이어야 합니다."
        self._set_value("ShapeFormCommonAttr", value)

    @property
    def shape_form_charshapeattr(self):
        """양식개체 글자모양 속성."""
        value = self._get_value("ShapeFormCharshapeattr")
        if value is not None and not isinstance(value, FormCharshapeattr):
            return FormCharshapeattr(value)
        return value

    @shape_form_charshapeattr.setter
    def shape_form_charshapeattr(self, value):
        if value is None:
            return self._del_value("ShapeFormCharshapeattr")
        assert isinstance(value, FormCharshapeattr), "값은 FormCharshapeattr 객체이어야 합니다."
        self._set_value("ShapeFormCharshapeattr", value)

    @property
    def shape_form_button_attr(self):
        """양식개체 버튼 속성."""
        value = self._get_value("ShapeFormButtonAttr")
        if value is not None and not isinstance(value, FormButtonAttr):
            return FormButtonAttr(value)
        return value

    @shape_form_button_attr.setter
    def shape_form_button_attr(self, value):
        if value is None:
            return self._del_value("ShapeFormButtonAttr")
        assert isinstance(value, FormButtonAttr), "값은 FormButtonAttr 객체이어야 합니다."
        self._set_value("ShapeFormButtonAttr", value)

    @property
    def shape_form_combobox_attr(self):
        """양식개체 콤보박스 속성."""
        value = self._get_value("ShapeFormComboboxAttr")
        if value is not None and not isinstance(value, FormComboboxAttr):
            return FormComboboxAttr(value)
        return value

    @shape_form_combobox_attr.setter
    def shape_form_combobox_attr(self, value):
        if value is None:
            return self._del_value("ShapeFormComboboxAttr")
        assert isinstance(value, FormComboboxAttr), "값은 FormComboboxAttr 객체이어야 합니다."
        self._set_value("ShapeFormComboboxAttr", value)

    @property
    def shape_form_edit_attr(self):
        """양식개체 에디트박스 속성."""
        value = self._get_value("ShapeFormEditAttr")
        if value is not None and not isinstance(value, FormEditAttr):
            return FormEditAttr(value)
        return value

    @shape_form_edit_attr.setter
    def shape_form_edit_attr(self, value):
        if value is None:
            return self._del_value("ShapeFormEditAttr")
        assert isinstance(value, FormEditAttr), "값은 FormEditAttr 객체이어야 합니다."
        self._set_value("ShapeFormEditAttr", value)

    @property
    def shape_form_scrollbar_attr(self):
        """양식개체 스크롤바 속성."""
        value = self._get_value("ShapeFormScrollbarAttr")
        if value is not None and not isinstance(value, FormScrollbarAttr):
            return FormScrollbarAttr(value)
        return value

    @shape_form_scrollbar_attr.setter
    def shape_form_scrollbar_attr(self, value):
        if value is None:
            return self._del_value("ShapeFormScrollbarAttr")
        assert isinstance(value, FormScrollbarAttr), "값은 FormScrollbarAttr 객체이어야 합니다."
        self._set_value("ShapeFormScrollbarAttr", value)

    @property
    def shape_form_listbox_attr(self):
        """양식개체 리스트박스 속성."""
        value = self._get_value("ShapeFormListBoxAttr")
        if value is not None and not isinstance(value, FormListBoxAttr):
            return FormListBoxAttr(value)
        return value

    @shape_form_listbox_attr.setter
    def shape_form_listbox_attr(self, value):
        if value is None:
            return self._del_value("ShapeFormListBoxAttr")
        assert isinstance(value, FormListBoxAttr), "값은 FormListBoxAttr 객체이어야 합니다."
        self._set_value("ShapeFormListBoxAttr", value)
