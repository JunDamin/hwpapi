...
def replace_all(app:App, 
    ...
    # set old charshape
    set_charshape(p.FindCharShape, face_name=old_fontname, font_type=old_fonttype, bold=old_bold, italic=old_italic, strike_out_type=old_strike_out, underline_type=old_underline, ratio=old_fontratio)
    set_charshape(p.ReplaceCharShape, face_name=new_fontname, font_type=new_fonttype, bold=new_bold, italic=new_italic, strike_out_type=new_strike_out, underline_type=new_underline, ratio=new_fontratio)
