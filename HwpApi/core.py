...
# %% ../nbs/02_api/00_core.ipynb #95c30c7f-433b-4c6b-81ef-b6f14573f2ae
...
# %% ../nbs/02_api/00_core.ipynb #57ea633c-2d62-4d5c-aa4c-b196ffed14c1
...
# %% ../nbs/02_api/00_core.ipynb #91fc2fbc-2784-484d-a942-08fdf24831f1
class Engine:
    """
...
# %% ../nbs/02_api/00_core.ipynb #5e401017-eb38-41f7-99fa-830e795b60ff
class Engines:
    """
...
# %% ../nbs/02_api/00_core.ipynb #52a6c2a3-d829-4db8-9eb3-dbc84c2b74ce
class Apps:
    """
...
# %% ../nbs/02_api/00_core.ipynb #80344b16-1d5c-4c16-a7f8-db8f7256b0b5
class App:
    """
...
# %% ../nbs/02_api/00_core.ipynb #f6d29efb-53f0-424a-a652-babac1a1f9d4
@patch
...
# %% ../nbs/02_api/00_core.ipynb #1e635e18
@patch
...
# %% ../nbs/02_api/00_core.ipynb #d67a7b5e-e604-4c2a-8a6d-e4056d35a68e
@patch
...
# %% ../nbs/02_api/00_core.ipynb #a41fa337-89b3-4e57-85e3-778f0a71baa0
@patch
...
# %% ../nbs/02_api/00_core.ipynb #eda60c32-d1e4-417a-a23a-07ddc11b0ce8
@patch
...
# %% ../nbs/02_api/00_core.ipynb #9577748a-1167-479b-a77b-bccc31fe3f4b
@patch
...
# %% ../nbs/02_api/00_core.ipynb #66c39a95-12a1-427a-8613-22b2eb5f3e10
@patch
...
# %% ../nbs/02_api/00_core.ipynb #c8b7c5ee-0480-4f61-96d2-ec76b6fff98b
@patch
...
# %% ../nbs/02_api/00_core.ipynb #001b5497-8a97-41f0-8183-6d3bda5b85ab
@patch
...
# %% ../nbs/02_api/00_core.ipynb #3809847f-d58e-4ca5-9909-50156bc1d2a7
@patch
def close(app: App):
    """
...
# %% ../nbs/02_api/00_core.ipynb #2b9178f8-a364-4c4a-9ed3-a41a2addd835
@patch
def quit(app: App):
    """
...
# %% ../nbs/02_api/00_core.ipynb #60b12b70
@patch
...
# %% ../nbs/02_api/00_core.ipynb #1b550e62
@patch
...
# %% ../nbs/02_api/00_core.ipynb #e08655b8-f4b4-4c9f-bb37-fc14e949b817
@patch
...
# %% ../nbs/02_api/00_core.ipynb #fc4bce4c-318f-4207-8b69-3de8a65958aa
@patch
...
# %% ../nbs/02_api/00_core.ipynb #192e1ed2-c10a-4a5b-badf-38f12b08996b
@patch
...
# %% ../nbs/02_api/00_core.ipynb #349ce3c3-492f-48f1-bde0-b3a50397fb35
@patch
...
# %% ../nbs/02_api/00_core.ipynb #5768c259-3d17-44fe-842d-c8ec7b508ea5
@patch
def insert_text(
    app: App,
    text: str,
...
# %% ../nbs/02_api/00_core.ipynb #ea9cafbf-469e-4a16-9d69-15c651f2c512
def _get_text(app):
    """스캔한 텍스트 텍스트 제너레이터"""
    flag, text = 2, ""
...
# %% ../nbs/02_api/00_core.ipynb #9974a67a-3c5d-4b58-bb47-577469feab78
...
# %% ../nbs/02_api/00_core.ipynb #23e23a40-9bcc-4c27-aa21-7ab08458ab99
@patch
def setup_page(
    app: App,  # 앱 인스턴스
...
# %% ../nbs/02_api/00_core.ipynb #750f6607-3f28-4b1f-8e22-d37475afada7
@patch
def insert_picture(
    app: App,
    fpath,
...
# %% ../nbs/02_api/00_core.ipynb #5cea6d9a-da09-4c43-8312-1330ce58b2f9
@patch
...
# %% ../nbs/02_api/00_core.ipynb #5ddd4336-3f09-4e40-8965-c730a6dd2465
@patch
...
# %% ../nbs/02_api/00_core.ipynb #990b8ead-e289-448e-891f-2ba1f13eefc6
# 리팩터링된 get_text 함수
@patch
...
# %% ../nbs/02_api/00_core.ipynb #4c2ce1a2-cdee-4e8d-acbb-9aef4728f3bd
@patch
def find_text(
    app: App,
    text="",  # 찾을 텍스트
...
# %% ../nbs/02_api/00_core.ipynb #0299729b-cfaf-4938-985a-ecd71b66cd23
@patch
def replace_all(
    app: App,
    old_text="",
...
# %% ../nbs/02_api/00_core.ipynb #0bf33c31-57ee-496d-82eb-ab299df1ca41
@patch
def insert_file(
    app: App,
    fpath,
...
# %% ../nbs/02_api/00_core.ipynb #ab53657e-92a9-4e2a-ba35-62b578a72d54
@patch
def set_cell_border(
    app: App,
    top=None,
...
# %% ../nbs/02_api/00_core.ipynb #2f6e8da6-dbbd-4470-aa71-2ebff133eb0f
@patch
def set_cell_color(
